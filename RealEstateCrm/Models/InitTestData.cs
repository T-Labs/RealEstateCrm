...
namespace WebApp.Models
{
    public class InitTestData
    {
        ...
        public async void RoleSync(RoleManager<IdentityRole> roleManager)
        {
        ...
        public async void DatabaseInitData(ApplicationDbContext dbContext, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
        {
