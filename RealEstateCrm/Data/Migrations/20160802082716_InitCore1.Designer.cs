...
namespace WebApp.Migrations
{
    ...
    [Migration("20160802082716_InitCore1")]
    partial class InitCore1
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebApp.Entities.ApplicationUser")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("WebApp.Entities.Blacklist", b =>
                {
                    b.HasOne("WebApp.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApp.Entities.Customer", b =>
                {
                    ...
                    b.HasOne("WebApp.Entities.ApplicationUser", "CustomerAccount")
                        .WithMany()
