...
namespace WebApp.Models
{
    public static class InitTestData
    {
        ...
        public static async Task RoleSync(RoleManager<IdentityRole> roleManager)
        {
        ...
        public static async Task DatabaseInitData(ApplicationDbContext dbContext, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
        {
